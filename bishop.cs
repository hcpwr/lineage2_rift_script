...
public class Script: ScriptBase {
    ...
    string party_member_healer = "";   // Party Member 1
    ...
    void temp_test(){
        my_status();
        if(right_room()){
            Console.WriteLine("right_room() Farm BP");
            ...
            switch(where_i()){
                case 0:
                    if(Me.BuffEndtime(id_buff) == 0){
                        Console.WriteLine("Going for rebuff BP");
                        rebuff();
                        break;
                    }else{
                        Console.WriteLine("Spawn Point 0 BP");
                        first_time = true;
                        if(Client.Pve.Enabled){
                            Wait(2000);
                            Client.Pve.Enabled = false;
                ...
                case 1:
                    if(Me.BuffEndtime(id_buff) == 0){
                        ...
                        Console.WriteLine("Spawn Point 1 BP");
                        first_time = true;
                        if(Client.Pve.Enabled){
                            Wait(2000);
                            Client.Pve.Enabled = false;
